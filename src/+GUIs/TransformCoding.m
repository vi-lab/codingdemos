	...
	methods
        function obj = TransformCoding(encoder, decoder)
            ...
            if ~exist('encoder', 'var')
                ...
                encoder = JPEGEncoder('exampleImages/lena_color_256.bmp');
            end
            ...
            obj.hInputImageAxes = obj.createAxesForImage([.01 .50 .40 .40]);

            obj.hOutputImageAxes = obj.createAxesForImage([.01 .01 .40 .40]);

            obj.hQuantisationSlider = uicontrol('Style', 'slider', ...
                                                'Parent', obj.hExternalPanel, ...
                                                'Min', 0, 'Max', 100, ...
                                                'Units', 'Normalized', ...
                                                'Position', [.01 .46 0.4 0.03], ...
