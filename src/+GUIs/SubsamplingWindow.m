...
%   Detailed explanation goes here
   ...
   methods
        function obj = SubsamplingWindow(fileName)
            ...
            obj.createInputImageSelectComboBoxAndText([0.06 0.92 0.3 0.07], [0.06 0.9 0.2 0.08]);
           ...
           for i=1:3
               ...
               obj.hSubsampledImagePixelCount{i} = uicontrol('Parent', obj.hExternalPanel, ...
                                        ...
                                        'Units', 'Normalized', ...
                                        'HorizontalAlignment', 'left', ...
                                        'Position', [((0.33*(i-1))+0.01) 0.85 0.2 0.03], ...
                                        'Fontsize', 11, ...
                                        'FontName', 'Courier New',...
                                        'BackgroundColor', 'white');
               p = getpixelposition(obj.hSubsampledImagePixelCount{i});
               setpixelposition(obj.hSubsampledImagePixelCount{i}, [p(1) p(2) 250 30]);
