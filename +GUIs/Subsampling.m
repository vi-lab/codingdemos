...
%   All rights reserved.
   ...
   methods
        function obj = Subsampling(fileName, examplesDirectory)
            ...
            obj.hChannelSelectText = obj.createTextElement([0.35 0.96 0.22 0.03], 'Channel type to show:');
            ...
            obj.hInterpolationSelectText = obj.createTextElement([0.71 0.96 0.25 0.03], 'Interpolation for upsample:', 10, false);
            ...
            for i=1:3
                ...
                obj.createTextElement([((0.33*(i-1))+0.01) 0.3 0.2 0.03], 'Subsampling Mode:', 10);

                arrayfun(@(c, text)(...
                        obj.createTextElement([((0.34*(i-1))+(.01+(floor(c/3)*.15))) (.38+(rem(c+1,2)*.5)) .14 .1], text, 11, true, 'white', obj.hSelectedBlockPanel) ...
